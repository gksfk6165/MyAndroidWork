...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout ll = findViewById(R.id.linear); //멤버변수

        //방법2 : 익명 클래스 (anonymous class) 사용.
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { //클릭되었을때 호출되는 메소드 callback method
        ...
        Button Dec = findViewById(R.id.btnDec);
        Inc.setOnClickListener(new View.OnClickListener() {


            @Override
            public void onClick(View v) {
                float plus = tvResult.getTextSize();
                tvResult.setTextSize(0,plus+1);
            }
        });
