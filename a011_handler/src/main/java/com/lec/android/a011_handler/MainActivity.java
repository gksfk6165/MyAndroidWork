...
public class MainActivity extends AppCompatActivity {
    ...
    public void mOnClick(View v){
        ...
        tvMainValue.setText("메인 스레드 값 : "+mainValue);
        tvBackValue1.setText("작업 스레드1 값: "+backValue1);
        tvBackValue2.setText("작업 스레드2 값: "+backValue2);

    }//end mOnClick

    //안드로이드는 메인 쓰레드를 강제 종료 시킬 수 없다.
    ...
    class BackThread extends  Thread{
        ...
        public void run() {
            while(true){
                ...
                //작업 쓰레드에서 메인ui 직접 건드릴수 없다.
                //tvBackValue1.setText(""+backValue1); //CalledFromWrong ThreadExcepton
            }
        }
    }
