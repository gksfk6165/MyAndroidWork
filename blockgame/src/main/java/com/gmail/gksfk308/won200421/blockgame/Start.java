package com.gmail.gksfk308.won200421.blockgame;
...
public class Start extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView tvTime; //시간 표시
    TextView tvPoint; //점수 표시
    ...
    private int soundID_Error; // 음향 id : 블럭 못맞추었을때
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 상태바 (status bak) 없애기, 반드시 setContentView() 앞에서 처리
    ...
    public void onClick(View v) {
        //버튼을 눌렀을때 호출되는 콜백
        //블럭과 같은 색깔의 버튼이 눌렸는지 판별. 같은 블럭이면 이미지 블럭 한칸씩 내려오기, 맨위에는 새로운 블럭 생성
