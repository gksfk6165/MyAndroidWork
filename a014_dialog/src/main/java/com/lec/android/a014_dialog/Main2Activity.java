...
public class Main2Activity extends AppCompatActivity {
   ...
   @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showArlert(DIALOG_TEXT);
            }
        });
        btnList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showArlert(DIALOG_LIST);
            }
        });
        btnRadio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showArlert(DIALOG_RADIO);
            }
        });
       btnMultiChoice.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               showArlert(DIALOG_MULTICHOICE);
           }
       });
    ...
    protected AlertDialog.Builder showArlert(int id){
        switch (id){
            case DIALOG_TEXT:
            ...
            case DIALOG_LIST:
                ...
                builder2.setTitle("리스트 형식 다이어로그 제목")
