    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       btnDlgEvent.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ivDlgBanner.setImageResource(R.drawable.face18);
               Toast.makeText(getApplicationContext(),"다이얼로그 버튼을 눌렀어요.",Toast.LENGTH_SHORT).show();
           }
       });

        //Activity 에 Dialog 등록하기기
        dlg1.setOwnerActivity(MainActivity.this);
        dlg1.setCanceledOnTouchOutside(true);  //다이얼로그 바깥 영역 클릭시 (혹은 back 버튼 클릭시) hide
                                                //종료 할 것인지 여부, true 종료됨 ,false 종료 안됨
