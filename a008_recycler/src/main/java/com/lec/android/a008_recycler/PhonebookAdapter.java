...
// Adapter 객체 정의
// 데이터(Phonebook) 을 받아서, 각 itme 별로 View 생성
public class PhonebookAdapter  extends RecyclerView.Adapter<PhonebookAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //준비된 레이아웃(XML)으로부터 View 를 만들어 ViewGroup에 붙이고
        //그렇게 만들어진 View 를 리턴한다.
        View itemView = inf.inflate(R.layout.item,parent,false);

        //위에서 만들어진 새로운 View를 View를 ViewHolder에 담아 리턴
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                  ...
                  //Toast.makeText(v.getContext(),"position : "+position,Toast.LENGTH_SHORT).show();
                    ...
                    v.getContext().startActivity(intent);  //액티비티가 아니여서 startActivity 를 바로 사용 못해서 v.getContext() 로 액티비티를 만든다.
